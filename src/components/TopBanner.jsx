      ...
      <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-black text-white backdrop-blur-md border-b border-white/10 shadow-lg">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-20">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between py-3 sm:py-4 md:py-5 gap-3 lg:gap-0">
            ...
            {/* Center Section - Contact Info (Hidden on Mobile, Stacked on Tablet) */}
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[1000] flex items-center justify-center p-3 sm:p-4 md:p-6">
          ...
          >
            ...
            <div className="flex justify-between items-center p-5 sm:p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white/50 rounded-t-2xl">
              <div>
                <h3 className="text-xl sm:text-2xl md:text-3xl font-light text-gray-900 tracking-tight" style={{ fontFamily: "Georgia, serif" }}>
                  Quick Booking
                </h3>
                <p className="text-xs sm:text-sm text-gray-500 mt-1">Connect instantly via WhatsApp</p>
              </div>
              <button
            ...
            <form onSubmit={handleSubmit} className="p-5 sm:p-6 space-y-4 sm:space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 active:from-green-700 active:to-green-800 text-white py-4 rounded-xl font-bold text-sm sm:text-base shadow-xl hover:shadow-2xl active:scale-95 transition-all duration-300 flex items-center justify-center gap-2 uppercase tracking-wide"
              >
